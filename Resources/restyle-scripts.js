...
function cardCarouselAdjuster(version) {
    ...
    var gameText = [
        ...
        <br><br>While I could explain all the mechanics like the Rally system, boss items, and the Remnant mechanic, why not give the game a shot and discover it all yourself!', '<a class="btn btn-lg btn-custom btn-block" style="font-size:1.5em; text-align: center; padding-top: 0.313rem; font-weight: bold;" href="https://boschybee.itch.io/remnants" role="button" target="_blank">Play Remnants</a><br>Video Game Development Club (Released)'],
        ...
        <br><br> I ended up in a fairly managerial role, but still created systems related to difficulty scaling, and the player/time progression.', '<a class="btn btn-lg btn-custom btn-block" style="font-size:1.5em; margin-top: 20px; padding-top: 0.313rem; font-weight: bold;" href="https://boschybee.itch.io/dystopian-defiers" role="button" target="_blank">Play Dystopian Defiers</a><br>Video Game Development Club (Released)'],
    ...
    var codeText = [
        ...
        <br><br>However, one of the main issues is that a 6mx6m play area is required. That being said, we were fortunate enough to have that amount of space, and I even showed it to some of my friends. When not primed, most did not even realize!', '<a class="btn btn-lg btn-custom btn-block" style="font-size:1.5em; margin-top: 22px; margin-bottom: 20px; padding-top: 0.313rem; font-weight: bold;" href="https://drive.google.com/file/d/1IFCxx1gKcMkrqRqrD5Q7BpPmvSToRTD-/preview" role="button" target="_blank">Watch the Demo</a>CSCI 5619'],
        ...
        <br><br>We used an SPH fluid simulation to power the core of the gameplay. There are four levels inspired by the seasons, each with their own unique challenges. Help the lil fella cross the gap using the power of water pressure, and physics!', '<a class="btn btn-lg btn-custom btn-block" style="font-size:1.5em; margin-bottom: 20px; padding-top: 0.313rem; font-weight: bold;" href="https://theshoes.itch.io/platforming-under-pressure" role="button" target="_blank">Platform Under Pressure</a>CSCI 5611'],
