    ...
    longForm = String(
        ...
        for(var i = 0; i< tabNames.length; i++){
            ...
            longForm += 'style="padding-top: 6%; padding-bottom: 6%; font-size: 1.25rem;">\
                        <a class="nav-link waves-effect" id="' + tabNames[i] + '-tab" data-toggle="tab" href="#' + tabNames[i] + '" role="tab" aria-controls="' + tabNames[i] + '-tab" ';
...
function cardCarouselAdjuster(version) {
    var gameImages = ["./Resources/Project Data/vgdc.jpg", "./Resources/Project Data/SpringCleaning.png", "./Resources/Project Data/HighspeedHominids.jpg", "./Resources/Project Data/Remnants.png", "./Resources/Project Data/DystopianDefiers.png", "./Resources/Project Data/DanielRadcliffe.jpg", "./Resources/Project Data/SpaceBar.jpg", "./Resources/Project Data/PotionMan.jpg", document.getElementsByClassName("icon-generator")[0].href, "./Resources/Project Data/MurderousMishapEARLY.jpg", "./Resources/Project Data/MelodyMagicalDreamCourse.jpg", "./Resources/Project Data/SonicDrillLAST.jpg"];
    ...
    var gameText = [
        ...
        <br><br>I was Lead for most projects. I led the group, worked on anything, and supported everyone.<br><br>Art, Music, Programming, Managing Pushes, etc. I was either working on it or helping the people who were.', '<u><a class="waves-effect" href=https://vgdc.umn.edu/games/ target="_blank">VGDC Website</a></u>'],

        ['Spring Cleaning', 'A short game jam project. The theme we got was "Minimalism", and this short, silly game about cleaning your computer is the result!.\
        <br><br>The game jam was a 48 hour jam, so this game had to be made within that 48 hour window. I initially had to manage both the game jam and my group at the start, after a while I was mostly just in the trenches with my team. I was exhausted by the end, but it turned out great!', '<a class="btn btn-lg btn-custom btn-block waves-effect" style="font-size:1.5em; padding-top: 0.313rem; font-weight: bold;" href="https://boschybee.itch.io/spring-cleaning" role="button" target="_blank">Play Spring Cleaning!</a><br>Video Game Development Club'],
        ...
        <br><br>Up to 4 players \"Ape Out\" in online or splitscreen multiplayer to escape first and with the highest score. The Gorilla who shmooves the best and breaks out first wins!', '<a class="btn btn-lg btn-custom btn-block waves-effect" style="font-size:1.5em; padding-top: 0.313rem; font-weight: bold;" href="https://boschybee.itch.io/high-speed-hominids" role="button" target="_blank">Coming Soon!</a><br>Video Game Development Club (Coming Soon!)'],
        ...
        <br><br>While I could explain all the mechanics like the Rally system, boss items, and the Remnant mechanic, why not give the game a shot and discover it all yourself!', '<a class="btn btn-lg btn-custom btn-block waves-effect" style="font-size:1.5em; padding-top: 0.313rem; font-weight: bold;" href="https://boschybee.itch.io/remnants" role="button" target="_blank">Play Remnants</a><br>Video Game Development Club (Released)'],
    ...
    var codeText = [
        ...
        <br><br>We used an SPH fluid simulation to power the core of the gameplay. There are four levels inspired by the seasons, each with their own unique challenges. Help the lil fella cross the gap using the power of water pressure, and physics!', '<a class="btn btn-lg btn-custom btn-block waves-effect" style="font-size:1.5em; padding-top: 0.313rem; font-weight: bold;" href="https://theshoes.itch.io/platforming-under-pressure" role="button" target="_blank">Platform Under Pressure</a><br>CSCI 5611'],
