...
function cardCarouselAdjuster(version) {
    ...
    var gameText = [
        ...
        <br><br>The game jam was a 48 hour jam, so this game had to be made within that 48 hour window. I initially had to manage both the game jam and my group at the start, after a while I was mostly just in the trenches with my team. I was exhausted by the end, but it turned out great!', '<a class="btn btn-lg btn-custom btn-block" style="font-size:1.5em; padding-top: 0.313rem; font-weight: bold;" href="https://boschybee.itch.io/spring-cleaning" role="button" target="_blank">Play Spring Cleaning!</a><br>Video Game Development Club'],
        ...
        <br><br>Up to 4 players \"Ape Out\" in online or splitscreen multiplayer to escape first and with the highest score. The Gorilla who shmooves the best and breaks out first wins!', '<a class="btn btn-lg btn-custom btn-block" style="font-size:1.5em; padding-top: 0.313rem; font-weight: bold;" href="https://boschybee.itch.io/high-speed-hominids" role="button" target="_blank">Coming Soon!</a><br>Video Game Development Club (Coming Soon!)'],
